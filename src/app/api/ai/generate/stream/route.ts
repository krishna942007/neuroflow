...
const taskInstructions: Record<string, string> = {
  ...
  website_edit: 'You receive the current files dictionary and an edit request. Return ONLY the files you actually modified as {"files":{...}}. Do NOT return unchanged files — omit them entirely. Keep the entire UI code self-contained inside "App.jsx". Do NOT create additional files or sub-component folders. Self-close all void JSX tags. Maintain premium design with vibrant gradients, hover animations, and interactive states. Root layout: items-start justify-start, never vertically centered. ANIMATIONS: For animations, scroll/fade transitions, or interactive effects, you can import and use \'framer-motion\' (e.g. import { motion } from \'framer-motion\') or \'gsap\' (e.g. import gsap from \'gsap\') if requested. Be fast and efficient — respond with minimal JSON containing only changed files.',
